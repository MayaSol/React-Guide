...
* [10. Burger Builder Project: Accessing a Server](#section-10-burger-builder-project-accessing-a-servergit )
* [ Questions](#questions)
...
Для роутинга надо распарсить часть url после домена и в зависимости от ее значения отренедерить страницу. 
